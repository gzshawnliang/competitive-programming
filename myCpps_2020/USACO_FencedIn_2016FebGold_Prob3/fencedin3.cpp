...
int main()
{
    ...
    long long minCst = 0, sizD = doors.size();
    for (int i = 0, j = 0; i <= (n - 1)  || j <= sizD - 1; ++j)
    {
        int temp1=_find(doors[j].u);
        int temp2=_find(doors[j].v);
