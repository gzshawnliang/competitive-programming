...
int WordCount[MAX_NODE];            // 第i个结点如果是字符串的最尾的字符，存储数量
...
class trie
{
  public:
    ...
    trie()
    {
        ...
        // tr.clear();
        // tr.shrink_to_fit();
        // tr.assign(MAX_NODE, vector<int>(MAX_CHAR, 0));
