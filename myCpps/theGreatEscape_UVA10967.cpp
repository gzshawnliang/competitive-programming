...
ifstream fin("theGreatEscape_UVA10967.in");
ofstream fout("theGreatEscape_UVA10967.out");
...
int main()
{
    ...
    for (int t = 1; t <= tcc; ++t)
    {
        ...
        //     for (int x = 0; x <= m - 1; ++x)
        //     {
        //         if (a[y][x] == '.' || a[y][x] == '#') fout << a[y][x];
        //         else if (a[y][x] == 'N') fout << 'v';
        //         else if (a[y][x] == 'E') fout << '<';
        //         else if (a[y][x] == 'S') fout << '^';
        //         else fout << '>';
        //     }
