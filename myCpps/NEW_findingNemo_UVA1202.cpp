...
ifstream fin("NEW_findingNemo_UVA1202.in");
ofstream fout("NEW_findingNemo_UVA1202.out");
...
int main()
{
    ...
    while (true)
    {
        ...
        double nx_d, ny_d; fin >> nx_d >> ny_d;
