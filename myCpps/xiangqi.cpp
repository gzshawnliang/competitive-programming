 ...
 * @名称:		1589 xiangqi (AC)
 * @作者:		Shawn 
 * @创建时间: 2017-12-05 21:27:17 
 * @修改人:   Shawn 
 * @修改时间: 2017-12-05 21:27:17 
 * @备注:		复杂到爆炸（半藏）， 漏了别马脚，二次防守等情况
 * @题目来源： https://uva.onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&page=show_problem&problem=4464
***********************************************************/
#include <fstream>
#include <iostream>
#include <map>
...
int main()
{
    ...
    ifstream fin("xiangqi.in");
    ofstream fout("xiangqi.out");
    ...
    while (true)
    {
        ...
        point general;
        fin >> number >> general.x >> general.y;
        ...
        {
            chess temp;
            fin >> temp.type >> temp.Npos.x >> temp.Npos.y;
