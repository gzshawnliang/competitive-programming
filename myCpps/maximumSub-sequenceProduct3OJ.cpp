...
void solve()
{
    while (true)
    {
        ...
        if(size>0)
        {
            vector<bigint> maxProduct;
            vector<bigint> minProduct;
            ...
            for(int i=1;i<=size-1;++i)
            {
                ...
                bigint currMaxValue=0;
                bigint currMinValue=0;

                if(currItem>0)
                {
                    if(maxProduct[i-1]>0 && minProduct[i-1]>0)
                    {
                        currMaxValue = maxProduct[i-1] * currItem;
                        currMinValue = currItem;
                    }
                    else if(maxProduct[i-1]>0 && minProduct[i-1]<0)
                    {
                        currMaxValue = maxProduct[i-1] * currItem;
                        currMinValue = minProduct[i-1] * currItem;
                    }
                    else if(maxProduct[i-1]<0 && minProduct[i-1]<0)
                    {
                        currMaxValue = currItem;
                        currMinValue = minProduct[i-1] * currItem;
                    }
                    else if(maxProduct[i-1]==0 && minProduct[i-1]==0)
                    {
                ...
                else if(currItem<0)
                {
                    ...
                    {
                        currMaxValue = currItem;
                        currMinValue = maxProduct[i-1] * currItem;
                    }
                    else if(maxProduct[i-1]>0 && minProduct[i-1]<0)
                    {
                        currMaxValue = minProduct[i-1] * currItem;
                        currMinValue = maxProduct[i-1] * currItem;
                    }
                    else if(maxProduct[i-1]<0 && minProduct[i-1]<0)
                    {
                ...
                maxProduct.push_back(currMaxValue);
                minProduct.push_back(currMinValue);
            }
